#!/usr/bin/env python3
"""Run second-stage minimal-sufficient co-label adjudication."""
...
from bio_know_tag.co_label_judge import run_co_label_judge
...
def main() -> int:
    ...
    parser.add_argument("--first-stage-results", type=Path, required=True)
    ...
    parser.add_argument("--char-budget", type=int, default=45_000)
    ...
    report = run_co_label_judge(
        args.samples,
        args.first_stage_results,
        args.labels,
        run_dir,
        client,
        model=args.model,
